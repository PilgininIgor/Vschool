...
namespace ILS.PhotonServer.MasterServer.GameServer
{
    ...
    using ILS.PhotonServer.Common;
    using ILS.PhotonServer.LoadShedding;
    using ILS.PhotonServer.Operations;
    using ILS.PhotonServer.ServerToServer.Events;
    using ILS.PhotonServer.ServerToServer.Operations;
    using Photon.SocketServer;
    using Photon.SocketServer.ServerToServer;

    using OperationCode = ILS.PhotonServer.ServerToServer.Operations.OperationCode;
