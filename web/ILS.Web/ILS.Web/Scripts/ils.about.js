...
function selectAuthors() {
    ...
    selected = 0;
    sliderAuthorsInit();
    document.getElementById('authorsButton').src = "/Content/Sprites/about/authorsSel.png";
    document.getElementById('screensButton').src = "/Content/Sprites/about/screens.png"
    document.getElementById('awardsButton').src = "/Content/Sprites/about/awards.png"
    document.getElementById('achievementsButton').src = "/Content/Sprites/about/achievements.png"
...
function selectScreens() {
    ...
    selected = 1;
    sliderScreensInit();
    document.getElementById('authorsButton').src = "/Content/Sprites/about/authors.png";
    document.getElementById('screensButton').src = "/Content/Sprites/about/screensSel.png"
    document.getElementById('awardsButton').src = "/Content/Sprites/about/awards.png"
    document.getElementById('achievementsButton').src = "/Content/Sprites/about/achievements.png"
...
function selectAwards() {
    ...
    document.getElementById('authorsButton').src = "/Content/Sprites/about/authors.png";
    document.getElementById('screensButton').src = "/Content/Sprites/about/screens.png"
    document.getElementById('awardsButton').src = "/Content/Sprites/about/awardsSel.png"
    document.getElementById('achievementsButton').src = "/Content/Sprites/about/achievements.png"
    document.getElementById('authorsContainer').style.display = "none";
    document.getElementById('screensContainer').style.display = "none";
...
function selectAchievements() {
    ...
    document.getElementById('screensButton').src = "/Content/Sprites/about/screens.png"
    document.getElementById('awardsButton').src = "/Content/Sprites/about/awards.png"
    document.getElementById('achievementsButton').src = "/Content/Sprites/about/achievementsSel.png"
    document.getElementById('authorsContainer').style.display = "none";
    document.getElementById('screensContainer').style.display = "none";
    document.getElementById('awardsContainer').style.display = "none";
